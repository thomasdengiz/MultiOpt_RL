...
time_limit_in_seconds_for_local_search = 5 * 60
...
if __name__ == "__main__":
    ...
    days_for_simulation =  [3,  28, 37, 52, 65, 81, 294, 298, 310, 315, 339, 352]
    currentDatetimeString = datetime.today().strftime('%d_%m_%Y_Time_%H_%M_%S')
    simulationName = "RL1"
    df_results_multiopt_local_search = pd.DataFrame(columns=["Day","GD PF_Approx", "HV PF_Approx", "HV PF_Full", "HV_Ratio"])
        ...
        if useCentralizedOptimization == True:
            ...
            if useLocalSearch == True:
                ...
                for index_iteration in range (0, number_of_iterations_local_search):
                    ...
                    for index_solution_in_population in range (0, len (results_list_population)):
                        ...
                        for index_solution_local_seach in range (0, number_of_new_solutions_per_solution):
                            ...
                            model_path_extension = "RL1_Days12_SolSol20_SolIt20_ItDay3_ResStateTrue_DQN_kQ/trained_DQN_model"
                            model = DQN.load("C:/Users/wi9632/bwSyncShare/Eigene Arbeit/Code/Python/Demand_Side_Management/MultiOpt_RL/RL/RL_Models/" + model_path_extension)
                            ...
                            print(f"action_rl_agent1: {action_rl_agent1}")
                ...
                if calculate_pareto_front_comparisons == True:
                    ...
                    print(f"HELP pareto_front_approximation_values {pareto_front_approximation_values}")
                    print(f"HELP ind(pareto_front_approximation_values): {ind(pareto_front_approximation_values)}")
                    ...
                    new_row = {'Day': currentDay, 'GD PF_Approx': generational_distance_appximated_front,'HV PF_Approx': hypervolume_approximated_front,'HV PF_Full': hypervolume_full_front,'HV_Ratio': hypervolume_ratio_from_approximation_of_full_pareto_front,}
    ...
    df_results_multiopt_local_search.to_csv(folderPath_resultFile_multiOpt + "/RL1_result_multiopt_" + "min" + str(time_limit_in_minutes) + ".csv", sep=';',index=False)
