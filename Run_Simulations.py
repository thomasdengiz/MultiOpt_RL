...
daysOfTheYearForSimulation_Testing = [ 1]
...
if __name__ == "__main__":
    ...
    if useLocalSearch==True:
        ...
        df_results_multiopt_local_search.to_csv(folderPath_resultFile_multiOpt + "/LS_result_multiopt_" + "min" + str(time_limit_in_minutes) + ".csv", sep=';',index=False)
