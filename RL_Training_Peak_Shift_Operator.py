...
string_run_name = "RL3_Days" + str(number_of_days_for_training) + "_SolSol" + str (number_of_new_solutions_per_solution) + "_SolIt" + str(number_of_new_solutions_per_iteration) + "_ItDay" + str (number_of_iterations_per_day) + "_ResState" + str(use_resulting_state_after_action_as_current_solution) + "_StateTimeSlots" + str(timeslots_for_state_load_percentages_peak) + "_ShiftActions" +  str(number_of_discrete_shifting_actions)
...
class DSM_Env(Env):
    def __init__(self):
        ...
        action_space_bounds = [ timeslots_for_state_load_percentages_peak,number_of_discrete_shifting_actions + 1]
        ...
        low = np.zeros(timeslots_for_state_load_percentages_peak)
        high = np.full(timeslots_for_state_load_percentages_peak, 100.0, dtype=np.float64)
        ...
        low = np.zeros(timeslots_for_state_load_percentages_peak)
        high = np.ones(timeslots_for_state_load_percentages_peak)
